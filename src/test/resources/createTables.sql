CREATE OR REPLACE TABLE IF NOT EXISTS groups
(
...
CREATE OR REPLACE TABLE IF NOT EXISTS students
(
  id bigint NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE OR REPLACE TABLE IF NOT EXISTS courses
(
  id bigint NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE OR REPLACE TABLE IF NOT EXISTS groups_courses
(
...
CREATE OR REPLACE TABLE IF NOT EXISTS students_groups
(
...
CREATE OR REPLACE TABLE IF NOT EXISTS teachers
(
  id bigint NOT NULL GENERATED ALWAYS AS IDENTITY,
  first_name VARCHAR(30) NOT NULL CHECK (first_name != ''),
  last_name VARCHAR(30) NOT NULL CHECK (last_name != ''),
...
CREATE OR REPLACE TABLE IF NOT EXISTS lessons
(
  id bigint NOT NULL GENERATED ALWAYS AS IDENTITY,
  course_id INTEGER,
  teacher_id INTEGER,
...
CREATE OR REPLACE TABLE IF NOT EXISTS lessons_groups
(
  group_id bigint NOT NULL,
